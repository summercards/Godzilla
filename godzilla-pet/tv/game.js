...
function growthFeedback(text,color){flash=Math.max(flash,.14);hitFlash=Math.max(hitFlash,.1);floaters.push({x:p.x,y:p.ground-300,text,life:1.1,color:color||'#ffd76b'});}
