 ...
 *
 * 本文件派生自 godzilla-shinjuku/rig.js，仅改动一处：部件路径由 assets/rig-source/
 * 改为桌宠自带的 ../assets/parts/。骨骼层级、枢轴、关键帧曲线与原始版本逐字一致，
 * 以避免两套动画产生差异。 */
(function(root){'use strict';
const PARTS={
  "jaw": {
    "src": "../assets/parts/jaw.png",
    "width": 134,
    "height": 114,
    "pivot": [
      8.8,
  ...
  "upper_arm": {
    "src": "../assets/parts/upper_arm.png",
    "width": 213,
    "height": 210,
    "pivot": [
      17.2,
  ...
  "far_thigh": {
    "src": "../assets/parts/far_thigh.png",
    "width": 298,
    "height": 285,
    "pivot": [
      33.2,
  ...
  "tail_base": {
    "src": "../assets/parts/tail_base.png",
    "width": 409,
    "height": 385,
    "pivot": [
      127.2,
