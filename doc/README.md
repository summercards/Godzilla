...
│                                外壳面板，外加一节「文档与代码不一致」
├── 变异视觉效果对账.md           【审计 · 2026-09-20】41 条突变逐条核对「字段有没有
│                                消费者」：10 条完全失效、12 条部分失效、9 个声明部位
│                                只有 3 个真的落成外观。含根因与分级修复建议
...
> 本文档出现 `game-design/…` 的地方，都读作「打算写到这里」。
> 现有 `doc/` 实际只有 `README.md`、`游戏逻辑梳理.md`、`变异视觉效果对账.md` 三份。
...
| [`变异视觉效果对账.md`](变异视觉效果对账.md) | 审计 | 41 条突变哪些真的改变了画面、哪些抽到等于没抽；含根因与修复清单 |
